...
LOCAL_C_INCLUDES := \
                    ...
                    $(LOCAL_PATH)/ffmpegMediaServer \
                    $(LOCAL_PATH)/ffmpegMediaServer/subsession \
...
FFMPEG_SERVER_SRC_FILES := \
                           ffmpegMediaServer/ffmpeg_demux.cpp \
                           ffmpegMediaServer/ffmpeg_demuxed_elementary_stream.cpp \
                           ffmpegMediaServer/ffmpeg_rtsp_server.cpp \
                           ffmpegMediaServer/ffmpeg_server_demux.cpp \
                           ffmpegMediaServer/subsession/ffmpeg_aac_server_media_subsession.cpp \
                           ffmpegMediaServer/subsession/ffmpeg_h264_server_media_subsession.cpp \
                           ffmpegMediaServer/subsession/ffmpeg_mp3_server_media_subsession.cpp \
                           ffmpegMediaServer/subsession/ffmpeg_mpeg4_server_media_subsession.cpp \

NIO_FFMPEG_COMPILE_FLAGS := -Wno-deprecated-declarations
NIO_ADDED_CPPFLAGS := $(NIO_FFMPEG_COMPILE_FLAGS) \
                      -Wno-tautological-constant-out-of-range-compare -Wno-self-assign-field -Wno-tautological-undefined-compare -Wno-array-bounds

#cpp flags?
LOCAL_CPPFLAGS := \
                  -DNULL=0 -DSCOKLEN_T=socklen_t -DNO_SSTREAM -DBSD=1 -DNO_SSTREAM -fexceptions -DANDROID -DXLOCALE_NOT_USED $(NIO_ADDED_CPPFLAGS)
...
FFMPEG_BINARIES := \
                   ...
                   $(LOCAL_PATH)/ffmpeg/lib/libssl.a \
                   $(LOCAL_PATH)/ffmpeg/lib/libcrypto.a \
...
LOCAL_SRC_FILES := \
                   NIORTSPServer_jni.cpp \
                   $(LIVE555_SRC_FILES) \
                   $(FFMPEG_SERVER_SRC_FILES) \

LOCAL_MODULE := libNIOLiveServer
